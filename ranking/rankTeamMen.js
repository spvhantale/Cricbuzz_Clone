...
document.querySelector("#team").style.fontWeight = "bold";
document.querySelector("#team").style.backgroundColor = "#009270";
...
document.querySelector("#allrounder").style.backgroundColor = "#CFE0DB";
function test() {
  query = "test";
  fetch(
    `https://unofficial-cricbuzz.p.rapidapi.com/stats/get-icc-rankings?category=teams&formatType=${query}&isWomen=0`,
    options
  )
...
let append = (array) => {
  ...
  array.forEach((element) => {
    if (element.rank == undefined) {
      ...
      img.src = `https://www.cricbuzz.com/a/img/v1/50x50/i1/c${element.imageId}/joe-root.jpg`;
